...
\begin{frame}{Validação da cinemática inversa.}
    ...
    \begin{itemize}
        \item Para cada matriz \(T\), verifica-se o número de configurações que resultam em soluções factíveis para a cinemática inversa.
        \item A configuração que resulta numa cinemática inversa mais próxima ao vetor de variáveis das juntas de referência é armazenada.
        \item Plota-se o gráfico que compara as variáveis das juntas determinadas pela cinemática inversa e as variáveis das juntas de referência para as matrizes de transformação.
    \end{itemize}
