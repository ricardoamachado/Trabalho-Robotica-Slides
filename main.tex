...
\begin{frame}{Cinemática Inversa Analítica do UR5}
    ...
    \[
        {}^{0}T_{6}\longrightarrow
        \{\theta_1,\theta_2,\theta_3,\theta_4,\theta_5,\theta_6\}
    \]

    A solução utiliza uma decomposição geométrica:
...
\begin{frame}{Determinação de $\theta_6$}
    ...
    A matriz homogênea é invertida
...
\begin{frame}{Determinação de $\theta_2$}
    ...
    A solução corresponde às configurações
...
\begin{frame}{Número de Soluções}
    ...
    A cinemática inversa do UR5 possui até
    ...
    Neste algoritmo são selecionadas através dos parâmetros
...
\begin{frame}{Validação da cinemática inversa.}
    ...
    %TODO: Colocar uma figura mais larga aqui
    \begin{figure}[htb]
        \centering
